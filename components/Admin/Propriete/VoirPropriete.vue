<template>
    <div class="project-single-admin area-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 row">
                        ...
                        <div class="row" id="slider" v-if="photos">
                            <div id="myCarousel" class="carousel slide">
                                ...
                                >
                                    ...
                                    <a href="#delete-modal" @click="chargeId(photo.picture.id)">
                                    <p class="icone_delete">
                    ...
                    <div class=" wrapper">
                        <a href="#demo-modal"><i class="fa fa-picture-o" aria-hidden="true"></i>
                        Ajouter Image</a>
                    </div> 
                    <NuxtLink :to="'/proprio/propriete/edit/'+proprieteId"><button class="custom-btn btn-30"><span>MODIFIER</span></button></NuxtLink>
                ...
                <div class="col-md-8 col-sm-6 col-xs-12">
                    <div class="feature_zone ">
                        ...
                        <div class="center" v-if="propriete.quartier">
                            <i class="fa_feature fa fa-map-marker" aria-hidden="true"></i> {{ propriete.quartier.name }}
                        </div>
                        ...
                        <div class="single-blog">
                            ...
                            <div class="propriete-actions text-center">
                                ...
                                <ul class="social-icon">
                                    ...
                                    <!-- <li><a class="instagram" href="#delete-modal" @click="chargeProp(propriete.id)"><i class="fa fa-trash" aria-hidden="true"></i></a></li> -->
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div id="demo-modal" class="modal">
                <div class="modal__content">
                    ...
                    <div class="col-md-12">
                        <label>Ajoutez une image pour cette propriété<span class="obligatoire">*</span></label> <br><br>
                        <input type="file" @change="handleFileUpload" size="70" name="file" ref="file" class="input_file_style_file" multiple /> <br><br><br>            
                    </div>
                    <button :class="{ 'btn-loading-admin': loading }" class=" btn-10" @click.prevent="AddPhoto()">Ajouter<span v-if="loading" class="spinner-admin"></span></button>
            ...
            <div id="delete-modal" class="modal">
                <div class="modal__content">
                    ...
                    <div class="cache" v-if="success_modal !='Photo supprimée avec succès'">
                        <h6>Voulez vous supprimer cette photo ? </h6><p><span class="obligatoire">*</span>Cette action est irréversible !</p>
                        <div class="col-md-12 confirm">
                                    <div class="col-md-6"><button class="custom-btn btn-300" :class="{ 'btn-loading-admin': loading }" @click.prevent="deletePhoto()"><span>OUI</span><span v-if="loading" class="spinner-admin"></span></button></div>
...
export default {
    ...
    methods: {
        ...
        AddPhoto(){
            ...
            this.$axios.post('/proprietes/pictures/add/'+ this.$route.params.id,formd)   
            .then(response =>{ 
                // console.log(response)     
                    this.loading = false;         
                if(response.data.status == "success"){
                    this.success_modal = "Photo enregistrée avec succès"
                    this.getPropriete();
                    // Si nécessaire, réinitialise également l'input file
        ...
        deletePhoto(){
          ...
          this.$axios.delete('/proprietes/pictures/delete/'+ this.photoId)
            .then(response => {
                this.loading = false; 
                // console.log(response)
                if(response.data.status == "success"){
                    this.getPropriete();
                    this.success_modal = "Photo supprimée avec succès"
