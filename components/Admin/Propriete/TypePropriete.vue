        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="single-well-admin mar-well">
                                ...
                                <p>
                                    Retrouvez vos propriétés triés par nombre de chambres. Les modifications sont toujours possibles.
                                </p>
                            </div>
                </div>
            </div>
            ...
            <div class="row div_filtre">
                <div class="col-md-4 filtre_propriete">
                    <v-select @input="getProprietes()" placeholder="Ville" class="select_ville" v-model="sort_by_ville" label="name" :options="villes"
...
export default {
    ...
    methods: {
        ...
        getProprietes(page=1) { 
            this.$axios.get('/types/proprietes',{
                params: {
